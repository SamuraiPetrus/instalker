<template>
    <div class="userheader is-flex is-justify-content-center mb-5 mt-5 is-flex-wrap-wrap">
        <figure class="user-profilepic mr-6">
            <img src="https://scontent-for1-1.cdninstagram.com/v/t51.2885-19/s150x150/106702189_270769510881748_1608525548909710164_n.jpg?_nc_ht=scontent-for1-1.cdninstagram.com&_nc_ohc=uWoLu28ahOQAX9O0DYs&tp=1&oh=1f4c5403895a262f9aea3b823a6c34a5&oe=60008798" alt="instagram profile picture of Millie Bobby Brown">
        </figure>
        <div class="user-header">
            <div class="is-flex is-align-items-center">
                <h1 class="is-size-3 mb-3">milliebobbybrown</h1>
            ...
            <div class="user-bio mb-5">
                <h2><strong>mills</strong></h2>
                <p class="mt-3">Lorem ipsum sit dolor amet.</p>
                <a class="mt-3 is-inline-block" href="#">florencebymills.com.br</a>
            </div>
